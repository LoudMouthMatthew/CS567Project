...
\vskip 0.02in
\begin{center}
\subfigure[Feature-family comparison across formulations.]{\includegraphics[width=0.48\textwidth]{figures/formulation_feature_relevance_comparison.pdf}}
\hfill
\subfigure[Validation permutation importance for the selected MLP.]{\includegraphics[width=0.48\textwidth]{figures/selected_mlp_permutation_importance.pdf}}
...
\section{Code}
\label{app:code}
Code repository: \url{https://github.com/LoudMouthMatthew/CS567Project}.
